        ...
        checkBoxFolder.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton arg0, boolean isChecked) {
                ...
                if (checkBoxFolder.isChecked()) {
                    AlertDialog.Builder alert = new AlertDialog.Builder(NewSettingsActivity.this);
                    alert.setTitle("Folder name");

                    // Set an EditText view to get user input
                    final EditText input = new EditText(NewSettingsActivity.this);
                    alert.setView(input);
                    ...
                    alert.setPositiveButton("Create", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            PreferenceManager.getDefaultSharedPreferences(NewSettingsActivity.this).edit()
